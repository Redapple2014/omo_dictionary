        ...
        renderItem={({ item, index }) => (
          ...
          <TouchableOpacity
            ...
            onPress={() => setSearchText(item)}>
             <View style={{ backgroundColor: 'white', flexDirection: 'row', height: 45, borderBottomWidth: .5, borderColor: Constants.appColors.LIGHTGRAY, alignItems: 'center', paddingHorizontal: 8,zIndex:3 }}>
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={{backgroundColor: 'red', height: isKeyboardVisible || searchText.length > 0 ? 100 : Sizes.WINDOW_HEIGHT * 0.38, backgroundColor: Constants.appColors.PRIMARY_COLOR, justifyContent: 'center', alignItems: 'center' }}>
        ...
        <CustomSearchBar
          ...
          containerStyle={{ padding: 0, margin: 0, borderRadius: 18, height: 45, width: '95%',top: isKeyboardVisible ? 24 : 190,position:'absolute',alignSelf:'center' }}
      ...
      {/* && isKeyboardVisible */}
{
        (reacientlySearchedData.length > 0 || searchText.length > 0)  ? <>
