  ...
  const getWordInfo = () => {
    const query = `SELECT words_info.id, words_info.lemma, words_info.partofspeech, words_info.origin, words_info.vocabularyLevel, words_info.lexicalUnit,
            words_info.homonym_number, words_info.annotation,
              ...
              FROM idioms_info where idioms_info.id = ${data?.id})
              AS idiomInfo,
              ...
              FROM idioms_en where idioms_en.id = ${data?.id})
              AS idiomsSense,
              ...
              FROM idioms_ex where idioms_ex.id = ${data?.id})
              ...
              FROM idioms_def where idioms_def.id = ${data?.id})
              AS idiomsDef
          ...
          <View style={{backgroundColor: 'white'}}>
            <ScrollView
              ...
              <View
                ...
                <View>{renderIdiomsData(wordInfo.idiomInfo)}</View>
              </View>
            </ScrollView>
          </View>
        </>
